			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">policy</span> - Listing all Vendors...</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Listing all policy</h5>
						<div class="header-elements">
							<div class="list-icons">
		                		
		                		<td><button type="button" class="btn bg-primary" data-toggle="modal" data-target="#modal_theme_primary">Return Policies</button></td>
		                	</div>
	                	</div>
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Return_policy 1</td>
								<td>
								Description 1 Descriptyion
								 </td>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-primary">
								<h6 class="modal-title">Add policy</h6>
